...
class TechniquesUi extends Ui {
	constructor(techniqueData) {
		...
		let treesLayout = new UiGridLayout(treesCoordinate, 1, 1 - treesCoordinate.top - Positions.MARGIN);
		techniqueData.trees.forEach((tree, treeIndex) => {
			...
			let treeLayout = new UiGridLayout(container.pad(Positions.MARGIN), 3, AllocationUi.height);
